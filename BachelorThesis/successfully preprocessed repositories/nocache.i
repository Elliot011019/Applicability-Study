...
# 123 "nocache.c"
   "fds != NULL"
# 123 "nocache.c" 3 4
   , "nocache.c", 123, __extension__ __PRETTY_FUNCTION__); }))
# 123 "nocache.c"
                      ;

    _original_open = (int (*)(const char *, int, mode_t)) dlsym(
# 125 "nocache.c" 3 4
                                                               ((void *) -1l)
# 125 "nocache.c"
                                                                        , "open");
    _original_open64 = (int (*)(const char *, int, mode_t)) dlsym(
# 126 "nocache.c" 3 4
                                                                 ((void *) -1l)
# 126 "nocache.c"
                                                                          , "open64");
    _original_creat = (int (*)(const char *, int, mode_t)) dlsym(
# 127 "nocache.c" 3 4
                                                                ((void *) -1l)
# 127 "nocache.c"
                                                                         , "creat");
    _original_creat64 = (int (*)(const char *, int, mode_t)) dlsym(
# 128 "nocache.c" 3 4
                                                                  ((void *) -1l)
# 128 "nocache.c"
                                                                           , "creat64");
    _original_openat = (int (*)(int, const char *, int, mode_t)) dlsym(
# 129 "nocache.c" 3 4
                                                                      ((void *) -1l)
# 129 "nocache.c"
                                                                               , "openat");
    _original_openat64 = (int (*)(int, const char *, int, mode_t)) dlsym(
# 130 "nocache.c" 3 4
                                                                        ((void *) -1l)
# 130 "nocache.c"
                                                                                 , "openat64");
    _original_dup = (int (*)(int)) dlsym(
# 131 "nocache.c" 3 4
                                        ((void *) -1l)
# 131 "nocache.c"
                                                 , "dup");
    _original_dup2 = (int (*)(int, int)) dlsym(
# 132 "nocache.c" 3 4
                                              ((void *) -1l)
# 132 "nocache.c"
                                                       , "dup2");
    _original_close = (int (*)(int)) dlsym(
# 133 "nocache.c" 3 4
                                          ((void *) -1l)
# 133 "nocache.c"
                                                   , "close");
    _original_fopen = (FILE *(*)(const char *, const char *)) dlsym(
# 134 "nocache.c" 3 4
                                                                   ((void *) -1l)
# 134 "nocache.c"
                                                                            , "fopen");
    _original_fopen64 = (FILE *(*)(const char *, const char *)) dlsym(
# 135 "nocache.c" 3 4
                                                                     ((void *) -1l)
# 135 "nocache.c"
                                                                              , "fopen64");
    _original_fclose = (int (*)(FILE *)) dlsym(
# 136 "nocache.c" 3 4
                                              ((void *) -1l)
# 136 "nocache.c"
                                                       , "fclose");
...
{
    int i;
    pthread_mutex_init(&fds_iter_lock, 
# 159 "nocache.c" 3 4
                                      ((void *)0)
# 159 "nocache.c"
                                          );
...
# 162 "nocache.c"
   "fds_lock != NULL"
# 162 "nocache.c" 3 4
   , "nocache.c", 162, __extension__ __PRETTY_FUNCTION__); }))
# 162 "nocache.c"
                           ;
    for(i = 0; i < max_fds; i++) {
        pthread_mutex_init(&fds_lock[i], 
# 164 "nocache.c" 3 4
                                        ((void *)0)
# 164 "nocache.c"
                                            );
...
# 241 "nocache.c"
   "_original_open != NULL"
# 241 "nocache.c" 3 4
   , "nocache.c", 241, __extension__ __PRETTY_FUNCTION__); }))
# 241 "nocache.c"
                                 ;
...
# 244 "nocache.c" 3 4
       ((void *)0)
# 244 "nocache.c"
       ) { fprintf(debugfp, "[nocache] DEBUG: " "open(pathname=%s, flags=0x%x, mode=0%o) = %d\n", pathname, flags, mode, fd); } } while(0)
                                      ;
        store_pageinfo(fd);
    }
    return fd;
...
# 257 "nocache.c" 3 4
   ((void *)0)) ; else __assert_fail (
# 257 "nocache.c"
   "_original_open64 != NULL"
# 257 "nocache.c" 3 4
   , "nocache.c", 257, __extension__ __PRETTY_FUNCTION__); }))
# 257 "nocache.c"
                                   ;
...
# 259 "nocache.c" 3 4
   ((void *)0)
# 259 "nocache.c"
   ) { fprintf(debugfp, "[nocache] DEBUG: " "open64(pathname=%s, flags=0x%x, mode=0%o)\n", pathname, flags, mode); } } while(0);
...
# 272 "nocache.c" 3 4
   ((void *)0)) ; else __assert_fail (
# 272 "nocache.c"
   "_original_creat != NULL"
# 272 "nocache.c" 3 4
   , "nocache.c", 272, __extension__ __PRETTY_FUNCTION__); }))
# 272 "nocache.c"
                                  ;
...
# 274 "nocache.c" 3 4
   ((void *)0)
# 274 "nocache.c"
   ) { fprintf(debugfp, "[nocache] DEBUG: " "creat(pathname=%s, flags=0x%x, mode=0%o)\n", pathname, flags, mode); } } while(0);
...
# 287 "nocache.c" 3 4
   ((void *)0)) ; else __assert_fail (
# 287 "nocache.c"
   "_original_creat64 != NULL"
# 287 "nocache.c" 3 4
   , "nocache.c", 287, __extension__ __PRETTY_FUNCTION__); }))
# 287 "nocache.c"
                                    ;
...
# 289 "nocache.c" 3 4
   ((void *)0)
# 289 "nocache.c"
   ) { fprintf(debugfp, "[nocache] DEBUG: " "creat64(pathname=%s, flags=0x%x, mode=0%o)\n", pathname, flags, mode); } } while(0);
...
# 302 "nocache.c" 3 4
   ((void *)0)) ; else __assert_fail (
# 302 "nocache.c"
   "_original_openat != NULL"
# 302 "nocache.c" 3 4
   , "nocache.c", 302, __extension__ __PRETTY_FUNCTION__); }))
# 302 "nocache.c"
                                   ;
...
# 304 "nocache.c" 3 4
   ((void *)0)
# 304 "nocache.c"
   ) { fprintf(debugfp, "[nocache] DEBUG: " "openat(dirfd=%d, pathname=%s, flags=0x%x, mode=0%o)\n", dirfd, pathname, flags, mode); } } while(0);
...
# 317 "nocache.c" 3 4
   ((void *)0)) ; else __assert_fail (
# 317 "nocache.c"
   "_original_openat64 != NULL"
# 317 "nocache.c" 3 4
   , "nocache.c", 317, __extension__ __PRETTY_FUNCTION__); }))
# 317 "nocache.c"
                                     ;
...
# 319 "nocache.c" 3 4
   ((void *)0)
# 319 "nocache.c"
   ) { fprintf(debugfp, "[nocache] DEBUG: " "openat64(dirfd=%d, pathname=%s, flags=0x%x, mode=0%o)\n", dirfd, pathname, flags, mode); } } while(0);
...
# 332 "nocache.c"
   "_original_dup != NULL"
# 332 "nocache.c" 3 4
   , "nocache.c", 332, __extension__ __PRETTY_FUNCTION__); }))
# 332 "nocache.c"
                                ;
...
# 334 "nocache.c" 3 4
   ((void *)0)
# 334 "nocache.c"
   ) { fprintf(debugfp, "[nocache] DEBUG: " "dup(oldfd=%d)\n", oldfd); } } while(0);
...
# 353 "nocache.c"
   "_original_dup2 != NULL"
# 353 "nocache.c" 3 4
   , "nocache.c", 353, __extension__ __PRETTY_FUNCTION__); }))
# 353 "nocache.c"
                                 ;
...
# 355 "nocache.c" 3 4
   ((void *)0)
# 355 "nocache.c"
   ) { fprintf(debugfp, "[nocache] DEBUG: " "dup2(oldfd=%d, newfd=%d)\n", oldfd, newfd); } } while(0);
...
# 366 "nocache.c" 3 4
   , "nocache.c", 366, __extension__ __PRETTY_FUNCTION__); }))
# 366 "nocache.c"
                                  ;
...
# 370 "nocache.c" 3 4
   ((void *)0)
# 370 "nocache.c"
   ) { fprintf(debugfp, "[nocache] DEBUG: " "close(%d)\n", fd); } } while(0);
...
# 381 "nocache.c" 3 4
   ((void *)0)) ; else __assert_fail (
# 381 "nocache.c"
   "_original_fopen != NULL"
# 381 "nocache.c" 3 4
   , "nocache.c", 381, __extension__ __PRETTY_FUNCTION__); }))
# 381 "nocache.c"
                                  ;
...
# 383 "nocache.c" 3 4
   ((void *)0)
# 383 "nocache.c"
   ) { fprintf(debugfp, "[nocache] DEBUG: " "fopen(path=%s, mode=%s)\n", path, mode); } } while(0);

    if((fp = _original_fopen(path, mode)) != 
# 385 "nocache.c" 3 4
                                            ((void *)0)
# 385 "nocache.c"
                                                )
...
# 400 "nocache.c" 3 4
   ((void *)0)) ; else __assert_fail (
# 400 "nocache.c"
   "_original_fopen64 != NULL"
# 400 "nocache.c" 3 4
   , "nocache.c", 400, __extension__ __PRETTY_FUNCTION__); }))
# 400 "nocache.c"
                                    ;
...
# 402 "nocache.c" 3 4
   ((void *)0)
# 402 "nocache.c"
   ) { fprintf(debugfp, "[nocache] DEBUG: " "fopen64(path=%s, mode=%s)\n", path, mode); } } while(0);

    if((fp = _original_fopen64(path, mode)) != 
# 404 "nocache.c" 3 4
                                              ((void *)0)
# 404 "nocache.c"
                                                  )
...
# 415 "nocache.c" 3 4
   , "nocache.c", 415, __extension__ __PRETTY_FUNCTION__); }))
# 415 "nocache.c"
                                   ;
...
# 463 "nocache.c" 3 4
   ((void *)0)
# 463 "nocache.c"
   ) { fprintf(debugfp, "[nocache] DEBUG: " "store_pageinfo(fd=%d): pages in cache: %zd/%zd (%.1f%%)  [filesize=%.1fK, " "pagesize=%dK]\n", fd, fds[fd].nr_pages_cached, fds[fd].nr_pages, fds[fd].nr_pages == 0 ? 0 : (100.0 * fds[fd].nr_pages_cached / fds[fd].nr_pages), 1.0 * fds[fd].size / 1024, (int) PAGESIZE / 1024); } } while(0)
...
# 504 "nocache.c" 3 4
       ((void *)0)
# 504 "nocache.c"
       ) { fprintf(debugfp, "[nocache] DEBUG: " "fadv_dontneed(fd=%d, from=0, len=0 [till end])\n", fd); } } while(0);
...
# 515 "nocache.c" 3 4
       ((void *)0)
# 515 "nocache.c"
       ) { fprintf(debugfp, "[nocache] DEBUG: " "fadv_dontneed(fd=%d, from=%zd, len=%zd)\n", fd, br->pos, br->len); } } while(0);
...
# 521 "nocache.c" 3 4
       ((void *)0)
# 521 "nocache.c"
       ) { fprintf(debugfp, "[nocache] DEBUG: " "fadv_dontneed(fd=%d, from=%lld, len=0 [till new end, file has grown])\n", fd, (long long)fds[fd].size); } } while(0)
                                          ;
