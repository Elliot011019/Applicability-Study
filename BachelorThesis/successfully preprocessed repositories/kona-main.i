...
# 23 "/usr/include/aarch64-linux-gnu/bits/stdint-uintn.h" 2 3 4
...
typedef struct m1{char a,b,c[sizeof(I)-3],d;I n;} M1;
typedef struct m0{M1 m1;I r;K k;} M0;
enum TYPE_SEVEN_MEMBERS {CONTeXT,DEPTH,CODE,LOCALS,PARAMS,CONJ,CACHE_WD,CACHE_TREE,TYPE_SEVEN_SIZE};

typedef struct node{V k,v;I b;struct node *c[2];}Node;typedef Node*N;
typedef struct pda{I i,s,n;S c;}Pda;typedef Pda*PDA;
typedef struct af{ V verb_over; V verb_scan; V verb_eachpair; } AF;
typedef struct tr{ I adverbClass; I arity; V func; S text; AF alt_funcs; } TR;
# 38 "src/incs.h" 2
